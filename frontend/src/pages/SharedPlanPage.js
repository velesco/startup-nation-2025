          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6 bg-gray-50 border-t">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <Link 
                  to="/#apply-section"
                  className="bg-gradient-orange-pink shine-effect text-white px-6 py-3 rounded-full text-lg font-medium shadow-md hover:shadow-lg transition-all duration-300"
                >
                  Înscrie-te acum
                </Link>
              </div>
